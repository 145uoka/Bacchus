 ...
 */
public class BsCandidateTCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected CandidateTCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsCandidateTCB() {
     ...
     * @return this. (NotNull)
     */
    public CandidateTCB acceptPK(Integer candidateNo) {
    ...
    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_CandidateNo_Desc();
        return this;
    }
     ...
     */
    public CandidateTCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public CandidateTCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected CandidateTCQ doGetConditionQuery() {
    ...
    protected CandidateTCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected CandidateTCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        CandidateTCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected CandidateTCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new CandidateTCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<CandidateTCB> unionCBLambda) {
        final CandidateTCB cb = new CandidateTCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final CandidateTCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<CandidateTCB> unionCBLambda) {
        final CandidateTCB cb = new CandidateTCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final CandidateTCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<CandidateTCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnEventStartDatetime() { return doColumn("event_start_datetime"); }
        /**
         ...
         */
        public HpSDRFunction<CandidateTCB, CandidateTCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<CandidateTCB> sq, CandidateTCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public CandidateTCB dreamCruiseCB() {
        CandidateTCB cb = new CandidateTCB();
        cb.xsetupForDreamCruise((CandidateTCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<CandidateTCB> columnQuery(final SpecifyQuery<CandidateTCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected CandidateTCB xcreateColumnQueryCB() {
        CandidateTCB cb = new CandidateTCB();
        cb.xsetupForColumnQuery((CandidateTCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<CandidateTCB> orCBLambda) {
        xorSQ((CandidateTCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<CandidateTCB> andCBLambda) {
        xorSQAP((CandidateTCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final CandidateTCB cb;
        if (mainCB != null) {
            cb = (CandidateTCB)mainCB;
        } else {
            cb = new CandidateTCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return CandidateTCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return CandidateTCQ.class.getName(); }

...
import com.Bacchus.dbflute.cbean.cq.bs.BsAuthMCQ;

/**
 * The condition-query of auth_m.
 * <p>
 ...
 */
public class AuthMCQ extends BsAuthMCQ {
     ...
     */
    public AuthMCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {

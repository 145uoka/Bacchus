...
import com.Bacchus.dbflute.cbean.cq.bs.BsGeneralCodeMCQ;

/**
 * The condition-query of general_code_m.
 * <p>
 ...
 */
public class GeneralCodeMCQ extends BsGeneralCodeMCQ {
     ...
     */
    public GeneralCodeMCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
